      ...
      <SafeAreaView style={styles.rootContainer}>
        ...
        >
         ...
         <View style={{justifyContent:'center', alignItems:'center'}}>
          ...
          {userData.role!=''?(<></>):(<>
          <TextInput onChangeText={(text)=>{console.log(text); if(text.length==6){checkCode(text)}}} keyboardType='number-pad' placeholder="код клуба" style={{fontSize:26, marginVertical:30, borderTopLeftRadius:15, borderTopRightRadius:15, borderBottomLeftRadius:15, borderBottomRightRadius:15}} maxLength={6}/>
</>)}
          </View>
        </View>
